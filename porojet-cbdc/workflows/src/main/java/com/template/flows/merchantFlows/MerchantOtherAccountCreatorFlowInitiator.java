...
public class MerchantOtherAccountCreatorFlowInitiator extends FlowLogic<AccountIdAndPassword> {
    ...
    public AccountIdAndPassword call() throws FlowException {
        ...
        AccountIdAndPassword accountIdAndPassword = generateAccountIdAndPasswordRandomly(merchantState, newMerchantAccount.getBankIndication());
        ...
        merchantAccount.setBankIndcation(newMerchantAccount.getBankIndication());

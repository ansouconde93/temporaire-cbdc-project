...
@InitiatedBy(CommercialBankCreatorFlowInitiator.class)
public class CommercialBankCreatorFlowAcceptor extends FlowLogic<Void> {
    private FlowSession otherPartySession;

    public CommercialBankCreatorFlowAcceptor(FlowSession otherPartySession) {

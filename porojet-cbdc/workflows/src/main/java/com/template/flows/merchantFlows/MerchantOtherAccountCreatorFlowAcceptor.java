...
public class MerchantOtherAccountCreatorFlowAcceptor extends FlowLogic<Void> {
    private FlowSession otherPartySession;

    public MerchantOtherAccountCreatorFlowAcceptor(FlowSession otherPartySession) {

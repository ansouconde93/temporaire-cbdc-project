 ...
 */
public class MerchantAuthenticationFilter extends UsernamePasswordAuthenticationFilter{

    private AuthenticationManager authenticationManager;

    public MerchantAuthenticationFilter(AuthenticationManager authenticationManager) {
        super();
